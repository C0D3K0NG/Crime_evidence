    ...
    return (
        <div className="flex min-h-screen bg-[#0c0f14] text-white font-sans overflow-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none overflow-hidden">
                ...
                {/* Slow ambient glows */}
                <div className="absolute bottom-0 left-1/4 w-[600px] h-[600px] rounded-full" style={{ background: "rgba(34,197,94,0.06)", filter: "blur(150px)", animation: "drift 20s ease-in-out infinite" }} />
                <div className="absolute -top-[100px] -right-[100px] w-[500px] h-[500px] rounded-full" style={{ background: "rgba(34,197,94,0.04)", filter: "blur(130px)", animation: "drift 25s ease-in-out infinite reverse" }} />
